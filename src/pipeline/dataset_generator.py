...
from src.pipeline.obstacle_simulation import ObstacleSimulator
...
def _build_meta(cfg: dict, sample: dict) -> dict:
    ...
    from src.pipeline.trajectory_generator import get_feature_names, TRAJECTORY_GENERATOR_VERSION
    from src.pipeline.obstacle_simulation import OBSTACLE_FEATURE_NAMES
